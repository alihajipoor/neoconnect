...
type Heartbeat struct {
	...
	RealityDestReachable bool   `protobuf:"varint,5,opt,name=reality_dest_reachable,json=realityDestReachable,proto3" json:"reality_dest_reachable,omitempty"`
	unknownFields        protoimpl.UnknownFields
	sizeCache            protoimpl.SizeCache
}
...
func (x *Heartbeat) GetRealityDest() string {
	if x != nil {
...
func (x *Heartbeat) GetRealityDestReachable() bool {
	if x != nil {
		return x.RealityDestReachable
	}
	return false
}
...
const file_agent_proto_rawDesc = "" +
	...
	"\ragent_version\x18\x05 \x01(\tR\fagentVersion\"\xd5\x01\n" +
	"\tHeartbeat\x12\x1f\n" +
	...
	"\freality_dest\x18\x04 \x01(\tR\vrealityDest\x124\n" +
	"\x16reality_dest_reachable\x18\x05 \x01(\bR\x14realityDestReachable\"~\n" +
	"\n" +
	"StatsBatch\x124\n" +
