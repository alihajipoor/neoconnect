...
const en = {
  ...
  "update.ready": "Neoxify {version} is ready. It installs when you close the app.",
  ...
  "settings.customHint": "Send only the apps you choose through the VPN. Everything else uses your normal connection.",
...
const fa: Record<TranslationKey, string> = {
  ...
  "update.ready": "نئوکسیفای {version} آماده است. هنگام بستن برنامه نصب می‌شود.",
