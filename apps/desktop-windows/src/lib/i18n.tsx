...
const en = {
  ...
  "dash.verifyingHint": "Setting up your tunnel. This can take a few seconds.",
  ...
  "err.notCarryingTraffic": "Connected, but no traffic got through — every protocol was tried.",
...
const fa: Record<TranslationKey, string> = {
  ...
  "dash.verifyingHint": "در حال برقراری تونل. ممکن است چند ثانیه طول بکشد.",
  ...
  "err.notCarryingTraffic": "اتصال برقرار شد اما ترافیکی عبور نکرد — همه پروتکل‌ها امتحان شدند.",
